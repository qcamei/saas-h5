  ...
  template: `
    ...
    <zm-page-content>
      <div style="padding:0 15px 20px 15px;">
        <h3 class="protocol-title">智美预约最终用户许可协议</h3>

        <div class="protocol-section" text-indent>重要须知——请认真阅读：本《最终用户许可协议》（以下称《协议》）是您（单一实体）与 智美预约软件产品之间有关上述智美预约软件产品的法律协议。</div>

        <div class="protocol-section" text-indent>本“软件产品”包括计算机软件，并可能包括相关微信公众号以及小程序、印刷材料或电子文档（“软件产品”操作手册）。本“软件产品”还包括智美预约软件产品提供给您的原“软件产品”的任何更新和补充资料。任何与本“软件产品”一同提供给您的并与单独一份最终用户许可证相关的软件产品是根据那份许可协议中的条款而授予您。您一旦安装、复制、下载、访问或以其它方式使用本“软件产品”，即表示您同意接受本协议各项条款的约束。如您不同意本协议中的条款，请不要安装或使用本“软件产品”。</div>
        ...
        <div class="protocol-section" text-indent>2.3商标。本《协议》不授予您有关任何智美预约系统商标或服务商标的任何权利。</div>
