...
@Component({
  ...
  template: `
        ...
        <div  fxLayout="row" fxLayoutAlign="start center" style="background:#f7f7f7;padding:10px;">
              <div text-center fxFlex="1 1" style="height: 35px;line-height: 35px;" *ngFor="let tabItem of tabList;" [class.active]="isActive == tabItem.value" 
