...
@Component({
  ...
  template: ` 
          <div class="">
            <button type="submit" class="btn  c-btn-blue  fz-18 btn-valid-success" style="height: 48px;padding:0;width: 100%;border: none;" [ngClass]="{'btn-valid-error':hasError}" [disabled]="!canSubmit"
                    (click)="submit()">{{text}}
            </button>
