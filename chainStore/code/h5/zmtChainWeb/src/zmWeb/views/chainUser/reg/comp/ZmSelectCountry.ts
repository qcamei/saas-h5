...
/**
 * 下拉选择select组件
 * eg: <zm_select_country (selectCallback)="changeOption($event)"></zm_select_country>
 */
@Component({
  selector: "zm_select_country",
  template: `
          <div class="text-center zm_select_country" style="height:48px;width:158px;z-index:99;position: relative;">
            <div class="cur-hand  c-input" (click)="clickEvent();">
            ...
            <ul class="hidden pos-r text-left pd-l-0" style="z-index: 5;" >
              <li class="choice1" (click)='selectLi("(+61)澳大利亚")'><span class="number dib mg-r-5">+61</span><span class="dib">澳大利亚</span></li>
              <li class="choice1" (click)='selectLi("(+863)澳门（中国）")'><span class="number dib mg-r-5">+863</span><span class="dib">澳门（中国）</span></li>
