 ...
 * 下拉选择select组件
 * eg:
 <zm_select  [label]="'接受状态'" nameValues="未接受:0,已接受:1,已取消:2,已完成:3"  [(zmValue)]="viewData.queryForm.status"   (selectCallback)="getAppointmentByReq()"></zm_select>
 */
@Component({
  selector:"zm_select",
  template:`
...
export class ZmSelect implements OnInit{
