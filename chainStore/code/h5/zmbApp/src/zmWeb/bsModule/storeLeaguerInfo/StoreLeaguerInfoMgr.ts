...
import {RemoveAttention} from "./apiData/RemoveAttention";
import {AddAttention} from "./apiData/AddAttention";


export class StoreLeaguerInfoMgr {

  public static getInstance():StoreLeaguerInfoMgr{
    return MgrPool.getInstance().get("StoreLeaguerInfoMgr",StoreLeaguerInfoMgr);
  }

  private storeLeaguerInfoDao: StoreLeaguerInfoDao;

  constructor() {
    this.storeLeaguerInfoDao = new StoreLeaguerInfoDao();
  }
   ...
   * @returns {Promise<boolean>}
   */
  public addLeaguerLabelList(storeId,leaguerLabelAddForms:Array<LeaguerLabelAddForm>):Promise<boolean>{
    let updateForm = new StoreLeaguerInfoUpdateApiForm();
    updateForm.updateType = StoreLeaguerInfoUpdateType.AddLeaguerLabelList;
    updateForm.storeId = storeId;
    updateForm.leaguerLabelAddForms = leaguerLabelAddForms;
    return this.storeLeaguerInfoDao.updateWithId(storeId,updateForm);
  }
   ...
   * @returns {Promise<boolean>}
   */
  public addAttention(storeId, leaguerId: string): Promise<boolean> {
    let updateForm: StoreLeaguerInfoUpdateApiForm = new StoreLeaguerInfoUpdateApiForm();
    updateForm.storeId = storeId;
    updateForm.updateType = StoreLeaguerInfoUpdateType.AddAttention;
    updateForm.addAttention = new AddAttention();
    updateForm.addAttention.leaguerId = leaguerId;
    return this.storeLeaguerInfoDao.updateWithId(storeId, updateForm);
  }
   ...
   * @returns {Promise<boolean>}
   */
  public removeAttention(storeId, leaguerId: string): Promise<boolean> {
    let updateForm: StoreLeaguerInfoUpdateApiForm = new StoreLeaguerInfoUpdateApiForm();
    updateForm.storeId = storeId;
    updateForm.updateType = StoreLeaguerInfoUpdateType.RemoveAttention;
    updateForm.removeAttention = new RemoveAttention();
    updateForm.removeAttention.leaguerId = leaguerId;
    return this.storeLeaguerInfoDao.updateWithId(storeId, updateForm);
  }
}
