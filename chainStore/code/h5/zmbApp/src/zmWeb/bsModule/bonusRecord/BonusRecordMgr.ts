...
export class BonusRecordMgr {
  ...
  public static getInstance():BonusRecordMgr{
    return MgrPool.getInstance().get("BonusRecordMgr",BonusRecordMgr);
  }
  constructor() {
    this.bonusRecordDao = new BonusRecordDao();
  }
