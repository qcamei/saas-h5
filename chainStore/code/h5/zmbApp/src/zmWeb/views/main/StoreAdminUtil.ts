...
export class StoreAdminUtil{
  ...
  private static getUserPermData(userPermSet:Array<number>,managePermSet:Array<number>):UserPermData{
    ...
    let finalPermSet = this.getUserFinalPermSet(userPermSet,managePermSet);
    userPermData.finalPermSet = finalPermSet;

    this.getPermData(userPermData,finalPermSet);
    return userPermData;
  }

  /**
   * 获取普通用户最终权限集合
   * @param {Array<number>} userPermSet
   * @param {Array<number>} managePermSet
   * @returns {Array<number>}
   */
  private static getUserFinalPermSet(userPermSet:Array<number>, managePermSet:Array<number>):Array<number>{
     let permSet = AppUtils.repeat(userPermSet,managePermSet);
     return permSet;
  }
   ...
   * @param {Array<number>} managePermSet
   */
  private static getBossUserFinalPermSet(managePermSet:Array<number>):Array<number>{
  ...
  public static buildBossUserPermData(managePermSet:Array<number>):UserPermData {
    ...
    let finalPermSet = this.getBossUserFinalPermSet(managePermSet);
    userPermData.finalPermSet = finalPermSet;
