export class Constants{
  ...
  public static USER_DEFAULT_IMG = "assets/img/default_avatar.png";

  public static MALE_DEFAULT_IMG = "img/logo/buser1/female_icon.jpg";
  public static FEMALE_DEFAULT_IMG = "img/logo/buser1/male_icon.jpg";
  ...
  public static DEFAULT_STORE_NAME = "请选择店铺";
  ...
  public static readonly NO_CONTENT="未填写";//没有值时，默认是 未填写

  public static readonly PAGE_ITEM_COUNT = 20;//分页请求，每页数量
