...
@Component({
  ...
  template: ` 
            ...
            <!--<ion-grid text-center *ngIf="totalSize>pageSize">-->
              <!--<ion-row>-->
                <!--<ion-col no-padding>-->
                  <!--<button ion-button  small [color]="color" [disabled]="curPage==1" (click)="btnClick(1)">首页</button>-->
                  <!--<button ion-button  small [color]="color" [disabled]="curPage==1" (click)="btnClick(curPage-1)">上一页-->
                  <!--</button>-->
                  <!--<button ion-button  small [color]="color" [disabled]="curPage==ceil(totalSize/pageSize)"-->
                          <!--(click)="btnClick(curPage+1)">下一页-->
                  <!--</button>-->
                  <!--<button ion-button  small [color]="color" [disabled]="curPage==ceil(totalSize/pageSize)"-->
                          <!--(click)="btnClick(ceil(totalSize/pageSize))">尾页-->
                  <!--</button>-->
                <!--</ion-col>-->
              <!--</ion-row>-->
            <!--</ion-grid>-->
