...
import {SimpleStore} from "../../../../zmWeb/comModule/session/SessionData";
...
export class ToolbarComponent implements OnInit,OnDestroy
{
  ...
  toogleStore(simpleStore:SimpleStore){
    this.data.storeName = simpleStore.name;
