...
@Injectable()
export class StoreProductInfoViewDataMgr { //场景：列表->编辑->列表
  ...
  public setAddTypeWithReturnViewData(viewData: AddTypeWithReturnViewData): void {
    this.addTypeWithReturnVDS.next(viewData);
  }

  public subscribeAddTypeWithReturnVD(func: (viewData: AddTypeWithReturnViewData) => void) {
