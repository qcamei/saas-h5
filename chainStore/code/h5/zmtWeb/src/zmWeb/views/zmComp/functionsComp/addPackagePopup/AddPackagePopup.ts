...
import {
  ProductData,
} from "../../../storeCardInfo/Comp/productCardContentComp/ProductCardContentCompViewData";
  ...
  <div animation-modal >
            ...
            <mat-dialog-content fusePerfectScrollbar>
                    ...
                    <div fxLayout="row wrap"  fxLayoutGap="20px" >
                       <zm-search-box [label]=" '查询'" [placeholder]="'请输入套餐名称'" [(zmValue)]="viewData.name" (callBack)="queryList()"></zm-search-box>

                       <zm-select style="width: 200px;" [label]="'分类'" [selectList]="data.packageTypeList" [(zmValue)]="viewData.typeId" value="id" name="name" (selectCallback)="queryList()"></zm-select>
                    ...
                    <div  fxLayout="row wrap" fxLayoutAlign="space-between start" fxLayoutGap="20px" class="zmFullWidth">
                                    ...
                                    <div fxFlex="1 1 35%">
                                           ...
                                           <zm-table-select-single [itemList]="data.packageDataList" (onSelected) = "choosePackage($event)"  
                                    ...
                                    <div fxFlex="1 1 58%">
                                         ...
                                         <zm-table class="c-table-title table table-bordered text-center">
                                                <thead >
            ...
            <mat-dialog-actions>
                <div  fxLayout="row wrap" fxLayoutAlign="end" fxLayoutGap="20px" class="zmFullWidth">
                   ...
                   <zm-btn-md  (click)="addPackageForCard()" name="确定"></zm-btn-md>
                </div>
            </mat-dialog-actions>
    </div>
...
export class AddPackagePopup implements OnInit {
  ...
  addPackageForCard() {
    ...
    for(let item of this.data.choosedPackageList){
      if(item.count==null){
