...
export abstract class AsyncRestDao<T> {
  ...
  public update4Resp(id, targetP): Promise<RestResp> {
    let uriPattern = "{0}/{1}/{2}";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, id);
  ...
  public addFormWithResp(findPath, addForm): Promise<RestResp> {
    let uriPattern = "{0}/{1}/{2}/";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, findPath);
    let daoTmp = this;
    return new Promise<RestResp>(resolve => {
  ...
  public upLoadFile(uriPath, formData): Promise<RestResp> {
    ...
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, uriPath);
    return new Promise<RestResp>(resolve => {
      this.restProxy.uploadFile(uri, formData).then(
        function (restResp) {
          resolve(restResp);
        }
      );
  ...
  public resolveExcel(uriPath, formData): Promise<RestResp> {
    let uriPattern = "{0}/{1}/{2}/";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, uriPath);
    let daoTmp = this;
    return new Promise<RestResp>(resolve => {
  ...
  public addAndReturnRestResp(targetP): Promise<RestResp> {
    let uriPattern = "{0}/{1}/";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table);
    let daoTmp = this;
    return new Promise<RestResp>(resolve => {
  ...
  public updateAndReturnRestResp(id, targetP): Promise<RestResp> {
    let uriPattern = "{0}/{1}/{2}";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, id);
    return new Promise<RestResp>(resolve => {
      this.restProxy.update(uri, targetP).then(
  ...
  public getByUri(suffix: string): Promise<RestResp> {
    let uriPattern = "{0}/{1}/{2}/";
    let uri = AppUtils.format(uriPattern, this.getService(), this.table, suffix);
    return this.restProxy.get(uri);
  }
